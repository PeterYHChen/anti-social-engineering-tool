...
## Introduction
This extension tells you in English if the site is bad or not. If you have a bit more experience, it will also shows what percentage of links go where. Here is a screenshot of our extension when hovering on a website with low reputation.
