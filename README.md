...
## Introduction
This a chrome extenstion that provides functionalities to analyze sites when hovering on them. By clicking on an extension icon at the top-right corner, a popup is displayed and you can select "Analyze links" to analyze all links on the current website. Then the analyzed links would be displayed in green. Now you are free to hover on any links in green and explore the site information of each link without visiting it.
